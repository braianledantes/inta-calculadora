...
const METRICAS = [
  ...
  { key: "dosisPorHora", label: "Dosis por ha", color: "#4caf50" },
  { key: "precioEnvase", label: "Precio envase (US$)", color: "#ff9800" },
  { key: "cantTratamientos", label: "Cant. tratamientos", color: "#1976d2" },
];

export default function GraficoFertilizacion({ title, data = [] }) {
