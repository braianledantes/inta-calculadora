...
export const CardSanitizantePlan = forwardRef(function CardSanitizantePlan({plan, sanitizantes, onUpdate, onDelete}, ref) {
  ...
  const onRefreshDolarSanitizante = () => {
    const sanitizante = { ...plan.sanitizante, precioEnvaseDolar: prevPrecioSanitizante };
    onUpdate(plan.id, sanitizante, plan.volumenPorHectarea, plan.cantTratamientos);
  };
        ...
        <div className="mb-6">
          ...
          <div className="grid lg:grid-cols-4 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <ContainerInputDolarRefresh
              value={plan.sanitizante.precioEnvaseDolar}
              onChange={onChangePrecioEnvaseDolar}
              onRefresh={onRefreshDolarSanitizante}
            />
