...
export const CardMaquinariaPlan = ({ plan, tractores, implementos, onUpdate, onDelete }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-xl mx-auto w-full sm:max-w-md md:max-w-3xl lg:max-w-4xl mb-10">
      <div className="px-6 pt-6 mb-8">
        ...
        <div className="mb-8">
          ...
          <div className="w-full grid sm:grid-cols-2 bg-green-50 text-green-800 p-4 rounded-bl-lg rounded-br-lg border border-green-900/10 shadow-sm gap-2 mt-4">
            <span>
              <span className="font-semibold tracking-wide">Amortización:</span>
              <span className="font-extrabold tracking-tight"> {plan.amortizacionTractor}<span className="font-semibold"> ARS/h</span></span>
            </span>
            <span>
              <span className="font-semibold tracking-wide">Conservación:</span>
              <span className="font-extrabold tracking-tight"> {plan.gastoConservacionTractor}<span className="font-semibold"> ARS/h</span></span>
            </span>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="w-full grid sm:grid-cols-3 bg-green-50 text-green-800 p-4 rounded-bl-lg rounded-br-lg border border-green-900/10 shadow-sm gap-2 mt-4">
            <span>
              <span className="font-semibold tracking-wide">Combustible:</span>
              <span className="font-extrabold tracking-tight"> {plan.costoCombustibleImplemento}<span className="font-semibold"> ARS/h</span></span>
            </span>
            <span>
              <span className="font-semibold tracking-wide">Amortización:</span>
              <span className="font-extrabold tracking-tight"> {plan.amortizacionImplemento}<span className="font-semibold"> ARS/h</span></span>
            </span>
            <span>
              <span className="font-semibold tracking-wide">Conservación:</span>
              <span className="font-extrabold tracking-tight"> {plan.gastoConservacionImplemento}<span className="font-semibold"> ARS/h</span></span>
            </span>
          </div>
        </div>
      </div>
