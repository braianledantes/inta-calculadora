...
export default StyleSheet.create({
  ...
  titleWithBackground: {
    fontSize: 14, marginBottom: 10, fontWeight: 'bold',
    backgroundColor: '#264653', color: '#fff', padding: 6,
  },
  ...
  headerCell: {
    flex: 1, fontSize: 10, padding: 4, fontWeight: 'bold',
    borderWidth: 0.5, borderColor: '#000000',
    backgroundColor: '#264653', color: '#FFFFFF'
  },
